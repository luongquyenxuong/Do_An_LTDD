...
//   PdtItem({Key? key,required this.id, required this.ten, required this.hinhAnh, required this.gia,required this.moTa,required this.thongTin,required this.idLoaiSp}) : super(key: key);
//   @override
